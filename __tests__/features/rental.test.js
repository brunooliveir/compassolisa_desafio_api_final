...
it('should get a rental by id', async() => {
    ...
    const response = await request(app)
        .get('/api/v1/rental/' + payload.body._id)
        .send()
...
it('should reject id, bad argument', async() => {
    ...
    const response = await request(app)
        .get('/api/v1/rental/' + locadoraTest._id)
        .send()
...
it('should get a rental by params', async() => {
    ...
    const responseNome = await request(app)
        .get('/api/v1/rental/' + '?nome=' + payload.body.nome)
        .send()
    ...
    const responseCnpj = await request(app)
        .get('/api/v1/rental/' + '?cnpj=' + payload.body.cnpj)
        .send()
    ...
    const responseCep = await request(app)
        .get('/api/v1/rental/' + '?cep=' + payload.body.endereco[0].cep)
        .send()
    ...
    const responseFlilial = await request(app)
        .get('/api/v1/rental/' + '?isFilial=' + 'true')
        .send()
...
it('should delete a rental by id', async() => {
    ...
    const response = await request(app)
        .delete('/api/v1/rental/' + payload.body._id)
        .send()
...
it('should update a rental by id', async() => {
    ...
    const payload = await request(app)
        .post('/api/v1/rental/')
        .send(locadoraTestOriginal)

    const response = await request(app)
        .put('/api/v1/rental/' + payload.body._id)
        .send(locadoraTestUpdate)
...
it('dont should update a rental by id', async() => {
    ...
    const response1 = await request(app)
        .put('/api/v1/rental/' + payload.body._id)
        .send(locadoraTestUpdateNameError)
    ...
    const response2 = await request(app)
        .put('/api/v1/rental/' + payload.body._id)
        .send(locadoraTestUpdateCnpjError)
